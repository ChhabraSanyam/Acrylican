...
const AnalyticsDashboard: React.FC = () => {
  ...
  const [engagementData, setEngagementData] = useState<EngagementDashboardData | null>(null);
  ...
  const [filters, setFilters] = useState<DashboardFilters>({
    dateRange: {
      start_date: format(startOfDay(subDays(new Date(), 30)), 'yyyy-MM-dd\'T\'HH:mm:ss'),
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Track your sales performance and engagement metrics across all platforms
              </p>
            </div>
            <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          />
          <EngagementChart 
            data={engagementData?.engagement_trend || []}
          />
        </div>
